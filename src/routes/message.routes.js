...
import { clearAllConversation, deleteMessage, editMessage, getAllMessage, getCloudfareR2url, sendNewMessage } from "../controllers/conversation.controller.js";

const router = express.Router();

router.post("/send/message/:targetUserId",userAuthentication, sendNewMessage); //for sending text message
router.post("/upload/file", getCloudfareR2url);
